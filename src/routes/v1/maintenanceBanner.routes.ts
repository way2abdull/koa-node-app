...
import { MONGO_ID_REGEX, COMMON_STATUS, JOI_ERROR_MESSAGES, DBENUMS } from '../../constant/appConstants';
import { MaintenanceBannerController } from '../../controllers/v1/maintenanceBanner.controller.';
...
export default (router: Router) => {
  ...
  router.post(
    ...
    validateRequestBody(
      Joi.object({
        ...
        platform: Joi.string().required().valid(...Object.values(DBENUMS.DEVICE_TYPE)),
        status: Joi.string().optional(),
      })
    ),
    basicAuth,
    // adminAuth,
    MaintenanceBannerController.addBanner
  );

  /**
   * @swagger
   * /v1/admin/maintenance-banner/list:
   *   get:
   *     tags:
  ...
  /**
   * @swagger
   * /v1/admin/maintenance-banner/{id}:
   *   put:
   *     tags:
   *       - Admin
  ...
  /**
   * @swagger
   * /v1/admin/maintenance-banner/status/{id}:
   *   patch:
   *     tags:
   *       - Admin
  ...
  router.patch(
    ...
    basicAuth,
    // adminAuth,
    MaintenanceBannerController.updateBannerStatus
  );
